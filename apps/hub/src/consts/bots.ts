// Auto-generated file from fetch-bots.ts
// Source: https://raw.githubusercontent.com/matomo-org/device-detector/master/regexes/bots.yml

export const bots = [
  { regex: 'WireReaderBot', name: 'WireReaderBot', category: 'Feed Fetcher', url: 'https://wirereader.app/' },
  {
    regex: 'monitoring360bot',
    name: '360 Monitoring',
    category: 'Site Monitor',
    url: 'https://www.360monitoring.io',
    producer: { name: 'Plesk International GmbH', url: 'https://www.plesk.com' },
  },
  {
  ...
  },
  {
    ...
    url: '',
    producer: { name: 'Clearspring Technologies, Inc.', url: 'http://www.clearspring.com' },
  },
  {
    regex: 'AhrefsBot',
    name: 'aHrefs Bot',
  ...
  },
  {
    ...
    producer: { name: 'The Apache Software Foundation', url: 'https://www.apache.org/foundation/' },
  },
  {
    regex: 'Apache/',
    name: 'Apache',
  ...
  },
  {
    ...
    producer: { name: 'Mediagreen Medienservice', url: 'http://www.backlink-check.de' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Microsoft Corporation', url: 'http://www.microsoft.com' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'The Laboratory for Web Algorithmics (LAW)', url: 'http://law.di.unimi.it/software.php#buging' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Certified Security Solutions', url: 'https://www.css-security.com/company/about-us/' },
  },
  {
  ...
  },
  {
    ...
    category: 'Crawler',
    url: '',
    producer: { name: 'Dataprovider B.V.', url: 'https://www.dataprovider.com/' },
  },
  {
    ...
    producer: { name: 'Daum Communications Corp.', url: 'http://www.kakaocorp.com/main' },
  },
  {
    regex: 'Dazoobot',
    name: 'Dazoobot',
  ...
  },
  {
    ...
    category: 'Crawler',
    url: '',
    producer: { name: 'Domain Re-Animator, LLC', url: 'http://domainreanimator.com' },
  },
  {
    regex: 'DotBot',
    name: 'DotBot',
  ...
  { regex: 'EMail Exractor', name: 'EMail Exractor', category: 'Crawler', url: '', producer: { name: '', url: '' } },
  {
    regex: 'evc-batch',
    name: 'evc-batch',
    category: 'Crawler',
    url: '',
    producer: { name: 'eVenture Capital Partners II, LLC', url: 'http://www.eventures.vc/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Jayde Online, Inc.', url: 'http://www.jaydeonlineinc.com' },
  },
  {
    regex: 'Ezooms',
    name: 'Ezooms',
  ...
  },
  {
    ...
    category: 'Feed Fetcher',
    producer: { name: 'David Smith & Developing Perspective, LLC', url: 'https://david-smith.org' },
  },
  {
    regex: 'Feedly',
    name: 'Feedly',
  ...
  { regex: 'Findxbot', name: 'Findxbot', category: 'Crawler', url: 'http://www.findxbot.com' },
  { regex: 'FreshRSS', name: 'FreshRSS', category: 'Feed Fetcher', url: 'https://freshrss.org/' },
  {
    regex: 'Genieo',
  ...
  { regex: 'gobuster', name: 'Gobuster', url: 'https://github.com/OJ/gobuster' },
  {
    regex: 'ichiro',
    name: 'Goo',
    category: 'Search bot',
  ...
  },
  {
    ...
    producer: { name: 'SentiOne S.A.', url: 'https://sentione.com/' },
  },
  {
  ...
  {
    regex: '(Google-(?:GeminiNotebook|NotebookLM))',
    name: '$1',
    category: 'AI Assistant',
  ...
  { regex: 'vuhuv(?:Bot|RBT)', name: 'vuhuvBot', category: 'Search bot', url: 'https://vuhuv.com/bot.html' },
  {
    regex: 'HTTPMon',
    name: 'HTTPMon',
    category: 'Site Monitor',
  ...
  { regex: 'inoreader\\.com', name: 'inoreader', category: 'Feed Reader', url: 'https://www.inoreader.com' },
  {
    regex: 'iisbot',
  ...
  { regex: 'k6/', name: 'K6', url: 'https://k6.io/' },
  {
    regex: 'kouio',
    name: 'Kouio',
    url: 'http://kouio.com/',
  ...
  },
  {
    ...
    producer: { name: 'Lighthouse', url: 'https://developers.google.com/web/tools/lighthouse' },
  },
  {
  ...
  },
  {
    ...
    category: 'Crawler',
    producer: { name: 'Robert Graham', url: 'https://github.com/robertdavidgraham' },
  },
  ...
  },
  {
    ...
    producer: { name: 'Nagios Plugins Development Team', url: 'https://nagios.org' },
  },
  { regex: 'nbertaupete95\\(at\\)gmail\\.com', name: 'nbertaupete95', category: 'Crawler' },
  {
  ...
  },
  {
    ...
    category: 'Search bot',
    url: 'https://www.openindex.io/about-our-spider/',
    producer: { name: 'Openindex B.V.', url: 'https://www.openindex.io/' },
  },
  {
    regex: 'spbot',
  ...
  },
  {
    ...
    producer: { name: 'OpenWebSpider Lab', url: 'http://lab.openwebspider.org' },
  },
  {
  ...
  { regex: 'phantomas/', name: 'Phantomas', category: 'Site Monitor', url: 'https://github.com/macbre/phantomas' },
  {
    regex: 'phpservermon',
    name: 'PHP Server Monitor',
    category: 'Site Monitor',
    url: 'https://github.com/phpservermon/phpservermon',
    producer: { name: 'PHP Server Monitor', url: 'http://www.phpservermonitor.org/' },
  },
  {
  ...
  { regex: 'Rainmeter', name: 'Rainmeter', category: 'Crawler', url: 'https://www.rainmeter.net' },
  {
    regex: 'redditbot',
    name: 'Reddit Bot',
    category: 'Social Media Agent',
  ...
  { regex: 'Scrapy', name: 'Scrapy', category: 'Crawler', url: 'http://scrapy.org' },
  {
    regex: 'Screaming Frog SEO Spider',
    name: 'Screaming Frog SEO Spider',
    category: 'Crawler',
    url: 'http://www.screamingfrog.co.uk/seo-spider',
    producer: { name: 'Screaming Frog Ltd', url: 'http://www.screamingfrog.co.uk' },
  },
  {
    regex: 'ScreenerBot',
    name: 'ScreenerBot',
  ...
  { regex: 'seoscanners\\.net', name: 'Seoscanners.net', category: 'Crawler', url: '' },
  {
    regex: 'SkypeUriPreview',
    name: 'Skype URI Preview',
    category: 'Service Agent',
    url: '',
    producer: { name: 'Skype Communications S.à.r.l.', url: 'https://www.skype.com' },
  },
  {
  ...
  { regex: 'SiteSucker', name: 'SiteSucker', category: 'Crawler', url: 'http://ricks-apps.com/osx/sitesucker/' },
  {
    regex: 'sixy\\.ch',
    name: 'Sixy.ch',
    category: 'Site Monitor',
  ...
  },
  {
    ...
    producer: { name: 'SSL Labs', url: 'https://www.ssllabs.com/about/assessment.html' },
  },
  {
    regex: 'StatusCake',
    name: 'StatusCake',
  ...
  { regex: 'Sparkler', name: 'Sparkler', category: 'Crawler', url: 'https://github.com/USCDataScience/sparkler' },
  {
    regex: 'Spinn3r',
    name: 'Spinn3r',
    category: 'Crawler',
  ...
  { regex: 'SputnikFaviconBot', name: 'Sputnik Favicon Bot', category: 'Crawler', url: '' },
  { regex: 'SputnikImageBot', name: 'Sputnik Image Bot', category: 'Crawler', url: '' },
  {
    regex: 'SurveyBot',
    name: 'Survey Bot',
    category: 'Search bot',
  ...
  { regex: 'TarmotGezgin', name: 'Tarmot Gezgin', url: 'http://www.tarmot.com/gezgin/', category: 'Search bot' },
  { regex: 'TelegramBot', name: 'TelegramBot', url: 'https://telegram.org/blog/bot-revolution' },
  {
    regex: 'TLSProbe',
    name: 'TLSProbe',
  ...
  { regex: 'theoldreader\\.com', name: 'theoldreader', category: 'Feed Reader', url: 'https://theoldreader.com' },
  {
    regex: 'Trackable/0\\.1',
    name: 'Chartable',
    category: 'Site Monitor',
  ...
  },
  {
    ...
    producer: { name: 'iParadigms, LLC.', url: 'https://www.turnitin.com/' },
  },
  {
    regex: 'TweetedTimes',
  ...
  { regex: 'PTST/', name: 'WebPageTest', category: 'Site Monitor', url: 'https://www.webpagetest.org' },
  {
    regex: 'WeSEE',
    name: 'WeSEE:Search',
    category: 'Search bot',
  ...
  { regex: 'YOURLS', name: 'Yourls', category: 'Crawler', url: 'http://yourls.org' },
  {
  ...
  { regex: 'zgrab', name: 'zgrab', category: 'Security Checker', url: 'https://github.com/zmap/zgrab' },
  {
    regex: 'Zookabot',
    name: 'Zookabot',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'Catchpoint Systems', url: 'https://www.catchpoint.com/' },
  },
  {
    regex: 'bitlybot',
    name: 'BitlyBot',
  ...
  { regex: 'nrsbot|NetResearchServer', name: 'NetResearchServer' },
  ...
  { regex: 'gigabot', name: 'Gigabot' },
  {
    ...
    producer: { name: 'Searchme, Inc.', url: 'https://web.archive.org/web/20070217233037/http://www.searchme.com/' },
  },
  {
    regex: 'Pompos',
    name: 'Pompos',
    ...
    producer: { name: 'ILIAD SA', url: 'https://www.iliad.fr/' },
  },
  {
    regex: 'PagePeeker',
    name: 'PagePeeker',
  ...
  { regex: 'WebThumbnail', name: 'WebThumbnail' },
  {
    ...
    producer: { name: 'Twotrees Technologies, LLC', url: 'https://twotrees.com/' },
  },
  ...
  { regex: 'RSSRadio \\(Push Notification Scanner;support@dorada\\.co\\.uk\\)', name: 'RSSRadio Bot' },
  { regex: '^sentry', name: 'Sentry Bot', producer: { name: 'Sentry', url: 'https://sentry.io' } },
  { regex: '^Spotify/[\\d.]+$', name: 'Spotify', producer: { name: 'Spotify', url: 'https://www.spotify.com' } },
  {
    regex: 'Embedly',
    name: 'Embedly',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'BrandVerity, Inc.', url: 'https://www.brandverity.com/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Fundació puntCAT', url: 'https://fundacio.cat/ca/domini/' },
  },
  {
    regex: 'Buck',
    name: 'Buck',
  ...
  },
  {
    ...
    producer: { name: 'TikTok Inc.', url: 'https://www.tiktok.com/' },
  },
  {
    regex: 'WikiDo',
    name: 'WikiDo',
    ...
    producer: { name: 'Fotolitografie Fiorentine di Becchi Antonio s.n.c.', url: 'https://www.wikido.com/' },
  },
  {
    ...
    producer: { name: 'TechFusion Ltd.', url: 'https://www.techfusion.com.cy/' },
  },
  {
    regex: 'AwarioRssBot',
    name: 'Awario',
  ...
  },
  {
    ...
    producer: { name: 'IBM Germany Research & Development GmbH', url: 'https://exchange.xforce.ibmcloud.com/' },
  },
  {
    regex: 'SMTBot',
    name: 'SMTBot',
  ...
  },
  {
    ...
    producer: { name: 'Universität Leipzig', url: 'https://www.uni-leipzig.de/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Carbon60 Operating Co. Ltd.', url: 'https://www.carbon60.com/' },
  },
  {
  ...
  },
  {
    ...
    name: 'OI-Crawler',
    category: 'Crawler',
    url: 'https://openintel.nl/webcrawl/',
    producer: { name: 'OpenINTEL', url: 'https://openintel.nl/' },
  },
  {
    regex: 'presearch[._]com',
    name: 'Presearch',
    category: 'Search bot',
    url: 'https://presearch.com/',
    producer: { name: 'Presearch.com Inc.', url: 'https://presearch.com/' },
  },
  {
    regex: 'Nutch',
  ...
  { regex: 'Vercelbot', name: 'Vercel Bot', category: 'Service bot', url: 'https://vercel.com' },
  { regex: 'Grammarly', name: 'Grammarly', category: 'Service bot', url: 'https://www.grammarly.com' },
  { regex: 'Domains Project', name: 'Domains Project', category: 'Crawler', url: 'https://domainsproject.org' },
  { regex: 'PetalBot', name: 'Petal Bot', category: 'Crawler', url: 'https://aspiegel.com/petalbot' },
  {
  ...
  { regex: 'Barkrowler', name: 'Barkrowler', category: 'Crawler', url: 'http://www.exensa.com/crawl' },
  {
    regex: 'BDCbot',
    name: 'BDCbot',
    category: 'Crawler',
    url: 'https://bigweb.bigdatacorp.com.br/pages/faq.aspx',
    producer: { name: 'BIG Data Solucoes Em Tecnologia de Informatica LTDA', url: 'https://bigdatacorp.com.br/' },
  },
  {
    regex: 'adbeat',
    name: 'Adbeat',
  ...
  },
  {
    ...
    producer: { name: 'ContentKing BV', url: 'https://www.contentkingapp.com/' },
  },
  {
    regex: 'MicroAdBot',
    name: 'MicroAdBot',
  ...
  { regex: 'PingAdmin\\.Ru', name: 'PingAdmin.Ru', category: 'Site Monitor', url: 'https://ping-admin.ru/' },
  { regex: 'notifyninja.+monitoring', name: 'Notify Ninja', category: 'Site Monitor', url: 'http://notifyninja.com' },
  {
    regex: 'WebDataStats',
    name: 'WebDataStats',
    category: 'Crawler',
    url: 'https://webdatastats.com/policy.html',
    producer: { name: 'WebTehRazrabotka LLC', url: 'https://webdatastats.com/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'VSI INNOVATION SAS', url: 'https://vsi-innovation.com/' },
  },
  {
    regex: 'veryhip',
    name: 'VeryHip',
  ...
  { regex: 'MuscatFerret', name: 'MuscatFerret', category: 'Crawler', url: 'http://www.webtop.com/' },
  {
    regex: 'PageThing\\.com',
    name: 'PageThing',
    category: 'Crawler',
    url: 'https://www.pagething.com/',
    producer: { name: 'SPECIALNOISE LTD', url: 'https://www.specialnoise.com/' },
  },
  {
    regex: 'ArchiveBox',
    name: 'ArchiveBox',
  ...
  },
  {
    ...
    category: 'Crawler',
    producer: { name: 'ProjectDiscovery, Inc.', url: 'https://projectdiscovery.io/' },
  },
  {
    regex: '.*\\.oast\\.',
    name: 'Interactsh',
  ...
  },
  {
    ...
    producer: { name: 'Palo Alto Networks, Inc.', url: 'https://www.paloaltonetworks.com/' },
  },
  {
    ...
    producer: { name: 'Huawei Technologies Co., Ltd.', url: 'https://huawei.com' },
  },
  {
  ...
  { regex: 'RyowlEngine', name: 'Ryowl', category: 'Crawler', url: 'https://ryowl.org' },
  { regex: 'OdklBot', name: 'Odnoklassniki Bot', category: 'Crawler', url: 'https://odnoklassniki.ru' },
  { regex: 'Mediatoolkitbot', name: 'Mediatoolkit Bot', category: 'Crawler', url: 'https://mediatoolkit.com' },
  { regex: 'ZoominfoBot', name: 'ZoominfoBot', category: 'Crawler', url: 'https://www.zoominfo.com' },
  { regex: 'WeViKaBot', name: 'WeViKaBot', category: 'Crawler', url: 'http://www.wevika.de' },
  {
    regex: 'SEOkicks',
    name: 'SEOkicks',
    category: 'Crawler',
  ...
  { regex: 'Plukkie', name: 'Plukkie', category: 'Crawler', url: 'http://www.botje.com/plukkie.htm' },
  { regex: 'proximic;', name: 'Comscore', category: 'Crawler', url: 'https://www.comscore.com/Web-Crawler' },
  ...
  },
  {
    ...
    producer: { name: 'NET SYSTEMS RESEARCH LLC', url: 'https://www.netsystemsresearch.com/' },
  },
  {
    regex: 'CensysInspect',
    name: 'CensysInspect',
  ...
  },
  {
    ...
    producer: { name: 'Global Digital Network Plus, LLC', url: 'https://gdnplus.com/' },
  },
  { regex: 'WellKnownBot', name: 'WellKnownBot', category: 'Crawler', url: 'https://well-known.dev' },
  { regex: 'Adsbot', name: 'Adsbot', category: 'Crawler', url: 'https://seostar.co/robot/' },
  {
    regex: 'MTRobot',
    name: 'MTRobot',
    category: 'Crawler',
  ...
  { regex: 'colly', name: 'colly', category: 'Crawler', url: 'https://github.com/gocolly/colly/' },
  { regex: 'l9tcpid', name: 'l9tcpid', category: 'Security Checker', url: 'https://github.com/LeakIX/l9tcpid' },
  { regex: 'l9explore', name: 'l9explore', category: 'Security Checker', url: 'https://github.com/LeakIX/l9explore' },
  {
    regex: 'l9scan/|^Lkx-.*/',
    name: 'LeakIX',
    category: 'Security Checker',
  ...
  { regex: 'MegaIndex\\.ru', name: 'MegaIndex', category: 'Crawler', url: 'https://megaindex.com/crawler' },
  {
    regex: 'Seekport',
    name: 'Seekport',
    category: 'Crawler',
  ...
  { regex: 'Seolyt(?:Bot)?', name: 'SeolytBot', category: 'Crawler', url: 'https://seolyt.com/' },
  {
    regex: 'YaK/',
    name: 'YaK',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'kubell Co., Ltd.', url: 'https://www.kubell.com/en/' },
  },
  { regex: 'LinkPreview', name: 'LinkPreview', category: 'Service Agent', url: 'https://www.linkpreview.net/' },
  { regex: 'JungleKeyThumbnail', name: 'JungleKeyThumbnail', category: 'Crawler', url: 'https://junglekey.com/' },
  {
  ...
  { regex: 'Cincraw', name: 'Cincraw', category: 'Crawler', url: 'http://cincrawdata.net/bot/' },
  {
    regex: 'CISPA Web Analyzer',
    name: 'CISPA Web Analyzer',
    category: 'Crawler',
    url: 'https://notify.cispa.de/',
    producer: { name: 'CISPA - Helmholtz-Zentrum für Informationssicherheit gGmbH', url: 'https://cispa.de/en' },
  },
  {
    regex: 'IonCrawl',
    name: 'IONOS Crawler',
  ...
  },
  {
    ...
    producer: { name: 'Hochschule für angewandte Wissenschaften München', url: 'https://www.hm.edu/' },
  },
  { regex: 'TigerBot', name: 'TigerBot', category: 'Crawler', url: 'https://tiger.ch/' },
  { regex: 'TestCrawler', name: 'TestCrawler', category: 'Crawler', url: 'https://www.comcepta.com/' },
  {
    regex: 'CrowdTanglebot',
    name: 'CrowdTangle',
    category: 'Crawler',
    url: 'https://help.crowdtangle.com/en/articles/3009319-crowdtangle-bot',
    producer: { name: 'CrowdTangle, Inc.', url: 'https://www.crowdtangle.com/' },
  },
  {
    ...
    producer: { name: 'McCann Disciplines, Ltd.', url: 'https://www.primis.tech/' },
  },
  {
    regex: 'OnalyticaBot',
    name: 'Onalytica',
  ...
  },
  {
    ...
    producer: { name: 'Ubermetrics Technologies GmbH', url: 'https://www.ubermetrics-technologies.com/' },
  },
  { regex: 'Abonti', name: 'Abonti', category: 'Crawler', url: 'http://abonti.com/' },
  {
  ...
  },
  {
    ...
    producer: { name: 'Beijing Tiantexin Tech. Co., Ltd.', url: 'https://en.ipip.net/' },
  },
  {
    regex: 'ev-crawler',
    name: 'Headline',
    ...
    producer: { name: 'e.ventures Managementgesellschaft mbH', url: 'https://headline.com/' },
  },
  {
    regex: 'webprosbot',
    name: 'WebPros',
  ...
  { regex: 'Wheregoes\\.com Redirect Checker', name: 'WhereGoes', category: 'Crawler', url: 'https://wheregoes.com/' },
  { regex: 'project_patchwatch', name: 'Project Patchwatch', category: 'Crawler', url: 'http://66.240.192.82/' },
  {
  ...
  },
  {
    ...
    producer: { name: 'Profound Networks, LLC', url: 'https://www.profound.net/' },
  },
  {
    ...
    producer: { name: 'GreenWave Online, Inc.', url: 'http://www.greenwaveonline.com/' },
  },
  {
    ...
    producer: { name: 'Valley Hosting, LLC', url: 'https://www.pagemodified.com/' },
  },
  {
    regex: 'adstxtlab\\.com',
    name: 'adstxtlab.com',
  ...
  { regex: 'aiHitBot', name: 'aiHitBot', category: 'Crawler', url: 'https://www.aihitdata.com/about' },
  { regex: 'DomainCrawler/', name: 'DomainCrawler', category: 'Crawler', url: 'https://domaincrawler.com/about-us/' },
  { regex: 'AdAuth', name: 'AdAuth', category: 'Crawler', url: 'https://www.adauth.com' },
  { regex: 'faveeo\\.com', name: 'Faveeo', category: 'Crawler', url: 'http://www.faveeo.com' },
  { regex: 'kozmonavt\\.', name: 'Kozmonavt', category: 'Crawler', url: 'https://kozmonavt.ml' },
  { regex: 'CriteoBot/', name: 'CriteoBot', category: 'Crawler', url: 'https://www.criteo.com/criteo-crawler/' },
  {
    regex: 'PayPal IPN',
    name: 'PayPal IPN',
    category: 'Service Agent',
  ...
  },
  {
    ...
    producer: { name: 'Jožef Stefan Institute', url: 'https://www.ijs.si/ijsw/JSI' },
  },
  {
    regex: 'CLASSLA',
    name: 'CLASSLA-web',
  ...
  },
  {
    ...
    producer: { name: 'Electronic Frontier Foundation', url: 'https://www.eff.org/' },
  },
  {
    regex: 'EFF DNT policy checker',
    name: 'EFF Do Not Track Policy Checker',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'Swoppen Systems GmbH', url: 'https://www.swoppen.com/de' },
  },
  {
    ...
    producer: { name: 'Ecommerce Operations B.V.', url: 'https://www.scamadviser.com/' },
  },
  {
  ...
  { regex: 'AFB', name: 'Allloadin Favicon Bot', category: 'Crawler', url: 'https://allloadin.com/' },
  {
    regex: 'LinkWalker',
    name: 'LinkWalker',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'White Source Ltd.', url: 'https://www.mend.io/free-developer-tools/renovate/' },
  },
  { regex: 'INETDEX-BOT', name: 'Inetdex Bot', category: 'Crawler', url: 'https://www.inetdex.com/' },
  {
    regex: 'NETZZAPPEN',
    name: 'NETZZAPPEN',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'PDR Labs', url: 'https://web.archive.org/web/20220420054123/http://www.pdrlabs.net/' },
  },
  {
    regex: 'Nicecrawler',
    name: 'NiceCrawler',
  ...
  },
  {
    ...
    producer: { name: 'Comodo Security Solutions, Inc.', url: 'https://www.comodo.com/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'LinkResearchTools GmbH', url: 'https://www.linkresearchtools.com/' },
  },
  {
    regex: 'EntferBot',
    name: 'Entfer',
  ...
  {
    regex: 'Doximity-Diffbot',
    name: 'Doximity-Diffbot',
    category: 'AI Data Scraper',
    url: 'https://docs.diffbot.com/docs/getting-started-with-crawl',
    producer: { name: 'Diffbot Technologies Corp.', url: 'https://www.diffbot.com/' },
  },
  {
    regex: '.+diffbot',
    name: 'Diffbot',
  ...
  { regex: '2ip bot', name: '2ip', category: 'Crawler', url: 'https://2ip.io/' },
  { regex: 'ReqBin Curl Client', name: 'ReqBin', category: 'Crawler', url: 'https://reqbin.com/curl' },
  {
    regex: 'XoviBot',
    name: 'XoviBot',
    category: 'Crawler',
  ...
  { regex: '^Verity', name: 'GumGum Verity', category: 'Service Agent', url: 'https://gumgum.com/verity' },
  {
    regex: 'hackermention',
    name: 'hackermention',
  ...
  },
  {
    ...
    producer: { name: 'BitSight Technologies, Inc.', url: 'https://www.bitsight.com/' },
  },
  { regex: 'Ezgif', name: 'Ezgif', category: 'Service Agent', url: 'https://ezgif.com/about' },
  {
    regex: 'intelx\\.io_bot',
    name: 'Intelligence X',
    category: 'Crawler',
    url: 'https://intelx.io/',
    producer: { name: 'Kleissner Investments s.r.o.', url: 'https://intelx.io/' },
  },
  {
    ...
    producer: { name: 'Grier Forensics, LLC', url: 'https://www.grierforensics.com/' },
  },
  {
    regex: 'AdsTxtCrawler/',
    name: 'AdsTxtCrawler',
    ...
    producer: { name: 'IAB Technology Laboratory, Inc.', url: 'https://iabtechlab.com/' },
  },
  {
    regex: 'Morningscore',
  ...
  },
  {
    ...
    producer: { name: 'BrightEdge Technologies, Inc', url: 'https://www.brightedge.com/' },
  },
  {
    regex: 'sfFeedReader',
    name: 'sfFeedReader',
  ...
  },
  {
    ...
    producer: { name: 'RWTH Aachen University', url: 'https://www.comsys.rwth-aachen.de/' },
  },
  {
    regex: 'newspaper',
    name: 'Scraping Robot',
  ...
  { regex: 'phpMyAdmin', name: 'phpMyAdmin', category: 'Service Agent', url: 'https://www.phpmyadmin.net/' },
  {
    regex: 'Matomo/[\\d.]+',
    name: 'Matomo',
    category: 'Service Agent',
  ...
  { regex: 'MADBbot', name: 'MADBbot', category: 'Crawler', url: 'https://madb.zapto.org/bot.html' },
  {
    regex: 'MeltwaterNews',
    name: 'MeltwaterNews',
    category: 'Crawler',
    producer: { name: 'Meltwater Deutschland GmbH', url: 'https://www.meltwater.com/' },
  },
  {
    regex: 'owler',
    name: 'OWLer',
    ...
    producer: { name: 'Open Search Foundation e.V.', url: 'https://openwebsearch.eu/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Bright Interactive Ltd', url: 'https://www.builtbybright.com/' },
  },
  {
    regex: 'DaspeedBot',
    name: 'DaspeedBot',
  ...
  { regex: 'GeedoBot', name: 'GeedoBot', category: 'Crawler', url: 'https://geedo.com/bot/' },
  {
    regex: 'GeedoProductSearch|GeedoShopProductFinder',
    name: 'GeedoShopProductFinder',
    category: 'Crawler',
  ...
  { regex: 'LetsearchBot', name: 'LetSearch', category: 'Crawler', url: 'https://letsearch.ru/bots' },
  { regex: 'Example3', name: 'Example3', category: 'Crawler', url: 'https://www.example3.com/' },
  {
    regex: 'StatOnlineRuBot',
    name: 'StatOnline.ru',
    category: 'Crawler',
    url: 'https://statonline.ru/',
    producer: { name: 'ООО «Регистратор доменных имен РЕГ.РУ»', url: 'https://statonline.ru/' },
  },
  {
    regex: 'Spawning-AI',
    name: 'Spawning AI',
  ...
  { regex: 'SiteScoreBot', name: 'SiteScore', category: 'Crawler', url: 'https://sitescore.ai/' },
  {
    regex: 'MBCrawler',
  ...
  { regex: '^pdrl\\.fm', name: 'Podroll Analyzer', category: 'Crawler', url: 'https://podroll.fm' },
  { regex: 'PodUptime/', name: 'PodUptime', category: 'Site Monitor', url: 'https://poduptime.com' },
  {
    regex: 'anthropic-ai',
    name: 'Anthropic AI',
    category: 'AI Data Scraper',
  ...
  },
  {
    ...
    producer: { name: 'SANDOBA//EBUSINESS SOLUTIONS', url: 'https://www.sandoba.com/' },
  },
  {
    regex: 'SirdataBot',
    name: 'Sirdata',
  ...
  },
  {
    ...
    producer: { name: 'Exipert, Inc.', url: 'https://www.checkmarknetwork.com/' },
  },
  {
    regex: 'cohere-ai',
    name: 'Cohere AI',
  ...
  },
  {
    ...
    producer: { name: 'The Trade Desk, Inc.', url: 'https://www.thetradedesk.com/' },
  },
  {
  ...
  { regex: 'Ruby, Twurly v', name: 'Twurly', category: 'Crawler', url: 'https://twurly.org/' },
  {
    regex: 'Mixnode(?:Cache)?',
    name: 'Mixnode',
    category: 'Crawler',
    url: 'https://www.mixnode.com/',
    producer: { name: 'Mixnode Technologies, Inc.', url: 'https://www.mixnode.com/' },
  },
  { regex: 'CSSCheck', name: 'CSSCheck', category: 'Validator' },
  {
  ...
  },
  {
    ...
    producer: { name: 'Chronicle Security Ireland Limited', url: 'https://chronicle.security/' },
  },
  {
    regex: 'TinEye',
    name: 'TinEye',
  ...
  },
  {
    ...
    producer: { name: 'Particify Gerhardt & Weingarten OHG', url: 'https://particify.de/en/' },
  },
  {
    regex: 'botify',
    name: 'Botify',
  ...
  },
  {
    ...
    producer: { name: 'AdScanner d.o.o', url: 'https://www.alleyesonscreens.com/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Shareaholic, Inc.', url: 'https://www.shareaholic.com/' },
  },
  { regex: 'keycdn-tools:', name: 'KeyCDN Tools', category: 'Service Agent', url: 'https://tools.keycdn.com/geo' },
  {
    regex: 'keycdn-tools/',
    name: 'KeyCDN Tools',
    category: 'Service Agent',
  ...
  { regex: 'WhatsMyIP\\.org', name: 'WhatsMyIP.org', category: 'Service Agent', url: 'https://www.whatsmyip.org/ua/' },
  {
    regex: 'SenutoBot',
    name: 'Senuto',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'Barracuda Networks, Inc.', url: 'https://www.barracudanetworks.com/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Ghost Inspector, Inc.', url: 'https://www.ghostinspector.com/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Axeman Technology Solutions LLP', url: 'https://axemantech.com/' },
  },
  {
    regex: 'Paqlebot',
    name: 'Paqlebot',
  ...
  { regex: 'Wibybot', name: 'Wibybot', category: 'Crawler', url: 'https://www.wiby.me/' },
  { regex: 'Synapse', name: 'Synapse', category: 'Crawler', url: 'https://github.com/matrix-org/synapse' },
  {
    regex: 'OSZKbot',
    name: 'OSZKbot',
    category: 'Crawler',
    url: 'http://mekosztaly.oszk.hu/mia/',
    producer: { name: 'National Szechenyi Library', url: 'https://webarchivum.oszk.hu/' },
  },
  {
    regex: 'ZoomBot',
    name: 'ZoomBot',
  ...
  { regex: 'OmtrBot', name: 'OmtrBot', category: 'Site Monitor' },
  {
    regex: 'WebMoney Advisor',
    name: 'WebMoney Advisor',
    category: 'Service Agent',
    url: 'https://advisor.web.money/en/',
    producer: { name: 'DEED Baltic, UAB', url: 'http://www.deed.lt/' },
  },
  { regex: 'WebMon/', name: 'WebMon', category: 'Site Monitor' },
  {
    regex: 'fragFINN',
    name: 'fragFINN',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'Open Technologies Bulgaria, Ltd.', url: 'https://kiwitcms.org' },
  },
  {
  ...
  { regex: 'URLSuMaBot', name: 'URLSuMaBot', category: 'Crawler', url: 'https://www.urlsuma.de/' },
  {
    regex: '360JK yunjiankong',
    name: '360JK',
    category: 'Site Monitor',
    url: 'http://jk.cloud.360.cn/',
    producer: { name: '360 Security Technology Inc.', url: 'https://www.360.cn/' },
  },
  {
    ...
    producer: { name: 'University of California, Santa Barbara', url: 'https://www.it.ucsb.edu/' },
  },
  {
  ...
  { regex: 'Who\\.is', name: 'Who.is Bot', category: 'Crawler', url: 'https://who.is/' },
  {
    regex: 'Probely',
    name: 'Probely',
    category: 'Security Checker',
    url: 'https://probely.com/sos/',
    producer: { name: 'Probely - Soluções de Cibersegurança, S.A.', url: 'https://probely.com/' },
  },
  {
    regex: 'Uptimia',
    name: 'Uptimia',
  ...
  },
  {
    ...
    producer: { name: 'Library and Archives Canada', url: 'https://library-archives.canada.ca/' },
  },
  {
    regex: 'InsytfulBot',
    name: 'InsytfulBot',
  ...
  },
  {
    ...
    producer: { name: 'Copyright Clearance Center, Inc.', url: 'https://www.copyright.com/' },
  },
  {
  ...
  { regex: 'Castopod', name: 'Castopod', category: 'Crawler', url: 'https://www.castopod.org/' },
  {
  ...
  { regex: 'PunkMap', name: 'Punk Map', category: 'Security Checker', url: 'https://github.com/openeasm/punkmap' },
  {
  ...
  { regex: 'ducks\\.party', name: 'ducks.party', category: 'Security Checker', url: 'https://ducks.party/' },
  {
    regex: 'DepSpid',
    name: 'DepSpid',
    category: 'Crawler',
  ...
  { regex: 'MakeMerryBot', name: 'MakeMerryBot', category: 'Crawler', url: 'https://makemerry.app/bots' },
  {
    regex: 'Timpibot',
    name: 'Timpibot',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'Erie Data Systems, LLC', url: 'https://www.eriedatasys.com/' },
  },
  {
  ...
  { regex: 'leak\\.info', name: 'leak.info', category: 'Crawler', url: 'http://www.leak.info/' },
  {
    regex: 'workona',
    name: 'Workona',
    category: 'Crawler',
  ...
  },
  {
    ...
    producer: { name: 'Functionize, Inc.', url: 'https://www.functionize.com/' },
  },
  {
    regex: 'Prerender',
    name: 'Prerender',
  ...
  },
  {
    ...
    producer: { name: 'The Wikimedia Foundation, Inc.', url: 'https://www.wikimedia.org/' },
  },
  {
    regex: 'MuckRack',
    name: 'MuckRack',
  ...
  { regex: 'Golfe', name: 'Golfe', category: 'Crawler', url: 'http://www.goo-olfe.ae/bot.html' },
  {
    regex: 'SpiderLing',
    name: 'SpiderLing',
    category: 'Crawler',
    url: 'https://nlp.fi.muni.cz/projects/biwec/',
    producer: { name: 'Natural Language Processing Centre', url: 'https://nlp.fi.muni.cz/' },
  },
  {
    regex: 'Bravebot',
    name: 'Bravebot',
  ...
  },
  {
    ...
    producer: { name: 'Valve Corporation', url: 'https://www.valvesoftware.com/' },
  },
  {
    regex: 'ohdear\\.app',
    name: 'Oh Dear',
  ...
  },
  {
    ...
    producer: { name: 'aStonish Studio Srl', url: 'http://www.astonishstudio.com/' },
  },
  {
    regex: 'Cotoyogi',
    name: 'Cotoyogi',
    ...
    producer: { name: 'Joint Support-Center for Data Science Research (ROIS-DS)', url: 'https://ds.rois.ac.jp/' },
  },
  { regex: 'SuggestBot', name: 'SuggestBot', category: 'Crawler', url: 'https://github.com/nettrom/suggestbot' },
  {
  ...
  },
  {
    ...
    producer: { name: 'Cyber Circus Limited', url: 'https://sitechecker.pro/' },
  },
  {
    regex: 'SBIder',
    name: 'SBIder',
    ...
    producer: { name: 'SiteSell Inc.', url: 'https://www.sitesell.com/' },
  },
  {
    ...
    producer: { name: 'Lightspeed Systems, Inc.', url: 'https://www.lightspeedsystems.com/' },
  },
  {
    regex: 'Research JLU',
    name: 'Research JLU',
    ...
    producer: { name: 'Justus Liebig University Giessen', url: 'https://www.uni-giessen.de/en' },
  },
  {
    ...
    producer: { name: 'University of Passau', url: 'https://www.uni-passau.de/en/' },
  },
  {
    regex: 'WPMU DEV',
    name: 'WPMU DEV',
    ...
    producer: { name: 'Incsub, LLC.', url: 'https://incsub.com/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Modat B.V.', url: 'https://www.modat.io/' },
  },
  {
  ...
  { regex: 'VORTEX/', name: 'VORTEX', category: 'Crawler', url: 'https://marty.anstey.ca/robots/vortex' },
  { regex: 'xtate/(\\d+\\.[.\\d]+)', name: 'xtate', category: 'Crawler', url: 'https://github.com/babycoff/xtate' },
  { regex: 'FediList Agent/', name: 'FediList', category: 'Social Media Agent', url: 'https://fedilist.com/' },
  {
    regex: 'Grafana/(\\d+\\.[.\\d]+)',
    name: 'Grafana',
    category: 'Site Monitor',
    url: 'https://github.com/grafana/grafana',
    producer: { name: 'Grafana Labs', url: 'https://grafana.com/' },
  },
  {
    regex: 'github-camo',
    name: 'Github Camo',
  ...
  },
  {
    ...
    category: 'Social Media Agent',
    url: 'https://bsky.app',
    producer: { name: 'Bluesky Social PBC', url: 'https://bsky.app' },
  },
  {
    regex: 'OpenGraph\\.io',
    name: 'OpenGraph.io',
  ...
  { regex: 'IbouBot', name: 'IbouBot', category: 'AI Search Crawler', url: 'https://ibou.io/iboubot.html' },
  {
    regex: 'AddSearchBot',
    name: 'AddSearchBot',
    category: 'Crawler',
  ...
  },
  {
    ...
    category: 'Social Media Agent',
    url: 'http://keybase.io',
    producer: { name: 'Zoom Video Communications, Inc', url: 'https://www.zoom.com/' },
  },
  {
    regex: 'Replicate-Bot',
    name: 'Replicate-Bot',
    ...
    producer: { name: 'Replicate, Inc.', url: 'https://replicate.com/' },
  },
  {
    regex: 'cypex\\.ai',
    name: 'Cypex',
    ...
    producer: { name: 'Cypex', url: 'https://cypex.ai/' },
  },
  {
    ...
    producer: { name: 'University of Applied Sciences Muenster', url: 'https://www.fh-muenster.de/' },
  },
  {
    regex: 'Together-Bot',
    name: 'Together-Bot',
    ...
    producer: { name: 'Together Computer Inc.', url: 'https://www.together.ai/' },
  },
  {
    regex: 'xAI-Bot',
    name: 'xAI-Bot',
    category: 'AI Data Scraper',
    url: 'https://x.ai/',
    producer: { name: 'X.AI LLC', url: 'https://x.ai/' },
  },
  {
    regex: 'Groq-Bot',
    name: 'Groq-Bot',
    category: 'AI Data Scraper',
    url: 'https://groq.com/',
    producer: { name: 'Groq, Inc.', url: 'https://groq.com/' },
  },
  {
    regex: 'bigsur\\.ai',
    name: 'Big Sur AI',
    category: 'AI Assistant',
    url: 'https://bigsur.ai/',
    producer: { name: 'Big Sur AI, Inc.', url: 'https://bigsur.ai/' },
  },
  {
    ...
    producer: { name: 'SideGuide Technologies, Inc.', url: 'https://www.sideguide.dev/' },
  },
  {
    regex: 'SecurityHeaders',
    name: 'SecurityHeaders',
    category: 'Security Checker',
    url: 'https://securityheaders.com/',
    producer: { name: 'Snyk Limited', url: 'https://snyk.io/' },
  },
  {
    regex: 'HaloBot',
    name: 'HaloBot',
    ...
    producer: { name: 'ARCHI301', url: 'https://www.haloscan.com/' },
  },
  {
    regex: 'RSiteAuditor',
    name: 'RSiteAuditor',
    ...
    producer: { name: 'My SEO Tool Inc', url: 'https://agencyanalytics.com/' },
  },
  {
    regex: 'ORTc\\.me',
    name: 'OpenRobotsTXT',
    ...
    producer: { name: 'Majestic-12 Limited', url: 'https://majestic.com/' },
  },
  { regex: 'obsrvr\\.net', name: 'Observer', category: 'Security Checker', url: 'https://obsrvr.net/about' },
  { regex: 'AliyunSecBot', name: 'AliyunSecBot', category: 'Security Checker', url: 'https://service.alibaba.com/' },
  {
    regex: 'Mediumbot',
    name: 'Mediumbot',
    category: 'Crawler',
    url: 'https://medium.com/',
    producer: { name: 'A Medium Corporation', url: 'https://medium.com/' },
  },
  { regex: 'Heexybot', name: 'Heexybot', category: 'Search bot', url: 'https://heexy.org/bot' },
  { regex: 'ForwardQR', name: 'ForwardQR', category: 'Service Agent', url: 'https://forwardqr.com/bot.html' },
  {
    regex: 'CybaaBot',
    name: 'CybaaBot',
    category: 'Security Checker',
    url: 'https://cybaa.io/bot-policy',
    producer: { name: 'Cybaa Ltd', url: 'https://cybaa.io/' },
  },
  {
    regex: 'CybaaAgent',
    name: 'CybaaAgent',
  ...
  },
  {
    ...
    producer: { name: 'DoubleVerify Inc.', url: 'https://doubleverify.com/' },
  },
  {
    regex: 'Assetnote',
    name: 'Assetnote',
    ...
    producer: { name: 'Assetnote Pty Ltd', url: 'https://www.assetnote.io/' },
  },
  {
    regex: 'UGAResearchAgent',
    name: 'UGAResearchAgent',
    category: 'Security Checker',
    url: 'https://nislabuga-scan.uga.edu/',
    producer: { name: 'School of Computing at the University of Georgia (UGA)', url: 'https://computing.uga.edu/' },
  },
  {
    regex: 'SERankingBacklinksBot',
    name: 'SERankingBacklinksBot',
    category: 'Crawler',
    url: 'https://help.seranking.com/hc/en-us/articles/23020353159964-SERankingBacklinksBot-Crawler',
    producer: { name: 'SER Acquisition Inc,', url: 'https://seranking.com/' },
  },
  { regex: 'VertexWP', name: 'VertexWP', category: 'Security Checker', url: 'https://vertexwp.com/bot' },
  { regex: 'Friendica', name: 'Friendica', category: 'Social Media Agent' },
  {
    regex: 'Webliobot',
    name: 'Webliobot',
    category: 'Crawler',
    url: 'https://help.weblio.jp/ejje/jpdictionary/j_info/j_i_bcontents/h0021',
    producer: { name: 'GRAS Group, Inc.', url: 'https://gras-group.co.jp/' },
  },
  { regex: 'sqalix', name: 'sqalix', category: 'Crawler', url: 'https://www.sqalix.com/' },
  {
    regex: 'RecordedFuture',
    name: 'RecordedFuture',
    category: 'Security Checker',
    url: 'https://www.recordedfuture.com/',
    producer: { name: 'Recorded Future, Inc.', url: 'https://www.recordedfuture.com/' },
  },
  {
    regex: 'Valimail',
    name: 'Valimail',
    ...
    producer: { name: 'Valimail Inc.', url: 'https://www.valimail.com/' },
  },
  {
    regex: 'FindFiles\\.net',
    name: 'FindFiles.net',
    ...
    producer: { name: 'FindFiles.net UG', url: 'https://findfiles.net/' },
  },
  { regex: 'WanscannerBot', name: 'WanscannerBot', category: 'Security Checker', url: 'https://abuse.pend.re/' },
  {
    regex: 'Kagibot',
    name: 'Kagibot',
    category: 'Search bot',
    url: 'https://kagi.com/bot',
    producer: { name: 'Kagi Inc.', url: 'https://kagi.com/' },
  },
  {
    regex: 'Ai2Bot-Dolma',
    name: 'Ai2Bot-Dolma',
    ...
    producer: { name: 'The Allen Institute for Artificial Intelligence', url: 'https://allenai.org/' },
  },
  {
    regex: 'Ai2Bot-DeepResearchEval',
  ...
  },
  {
    ...
    producer: { name: 'W.A.R.D. LLC', url: 'https://ward.ai/' },
  },
  {
    regex: 'Character-AI',
    name: 'Character-AI',
    ...
    producer: { name: 'Character Technologies, Inc.', url: 'https://character.ai/' },
  },
  {
    regex: 'DeepseekBot',
    name: 'DeepseekBot',
  ...
  },
  {
    ...
    producer: { name: 'Mistral AI', url: 'https://mistral.ai/' },
  },
  {
  ...
  },
  {
    ...
    producer: { name: 'Crawlspace Company', url: 'https://crawlspace.dev/' },
  },
  {
    regex: 'Devin',
    name: 'Devin',
    ...
    producer: { name: 'Cognition AI, Inc.', url: 'https://cognition.ai/' },
  },
  {
    regex: 'Andibot',
    name: 'Andibot',
    ...
    producer: { name: 'Andi', url: 'https://andisearch.com/' },
  },
  { regex: 'HypeStat', name: 'HypeStat', category: 'Crawler', url: 'https://hypestat.com/crawler' },
  {
    regex: 'StatusNestBacklinkSpider',
  ...
  },
  {
    ...
    producer: { name: 'RunPod Inc.', url: 'https://www.runpod.io/' },
  },
  {
    regex: 'HuggingFace-Bot',
    name: 'HuggingFace-Bot',
    category: 'AI Data Scraper',
    url: 'https://huggingface.co/',
    producer: { name: 'Hugging Face, Inc', url: 'https://huggingface.co/' },
  },
  { regex: 'LinkBloom', name: 'LinkBloom', category: 'Crawler', url: 'https://hamidsoltani.com/linkbloom' },
  { regex: 'img2dataset', name: 'img2dataset', category: 'Crawler', url: 'https://github.com/rom1504/img2dataset' },
  {
    regex: 'iAskBot',
    name: 'iAskBot',
    category: 'AI Data Scraper',
    url: 'https://iask.ai/',
    producer: { name: 'Ai Search Inc.', url: 'https://iask.ai/' },
  },
  {
    regex: 'LinerBot',
    name: 'LinerBot',
    ...
    producer: { name: 'Liner', url: 'https://liner.com/' },
  },
  {
    regex: 'Poggio-Citations',
    name: 'Poggio-Citations',
    category: 'AI Assistant',
    url: 'https://docs.poggio.io/dev-resources/robots',
    producer: { name: 'Poggio Labs, Inc.', url: 'https://poggio.io/' },
  },
  {
    regex: 'QualifiedBot',
    name: 'QualifiedBot',
    ...
    producer: { name: 'Qualified.com, Inc.', url: 'https://www.qualified.com/' },
  },
  {
    regex: 'ZanistaBot',
    name: 'ZanistaBot',
    ...
    producer: { name: 'Zanista AI LTD.', url: 'https://zanista.ai/' },
  },
  {
    regex: 'ChatGLM-Spider',
    name: 'ChatGLM-Spider',
    category: 'AI Data Scraper',
    url: 'https://chatglm.cn/',
    producer: { name: 'Beijing Zhipu Huazhang Technology Co., Ltd.', url: 'https://zhipuai.cn/' },
  },
  {
    regex: 'gochitchat\\.ai',
    name: 'Sider',
    category: 'AI Data Scraper',
    url: 'https://sider.ai/',
    producer: { name: 'Sider AI', url: 'https://sider.ai/' },
  },
  {
    regex: 'SBIntuitionsBot',
    name: 'SBIntuitionsBot',
    category: 'AI Data Scraper',
    url: 'https://www.sbintuitions.co.jp/en/bot/',
    producer: { name: 'SB Intuitions Corp.', url: 'https://www.sbintuitions.co.jp/' },
  },
  {
    regex: 'ias_crawler',
    name: 'IAS Crawler',
    ...
    producer: { name: 'Integral Ad Science, Inc.', url: 'https://integralads.com/' },
  },
  {
    regex: 'ias_wombles',
    name: 'IAS Wombles',
  ...
  },
  {
    ...
    producer: { name: 'Parallel Web Systems Inc.', url: 'https://parallel.ai/' },
  },
  {
    regex: 'LumeWebScan',
    name: 'LumeWebScan',
    ...
    producer: { name: 'LumeWeaver Labs', url: 'https://lumeweaver.com/' },
  },
  {
    regex: 'PanguBot',
    name: 'PanguBot',
    ...
    producer: { name: 'Huawei Technologies Co., Ltd.', url: 'https://www.huawei.com/' },
  },
  {
    regex: 'Manus-User',
    name: 'Manus-User',
    ...
    producer: { name: 'Butterfly Effect Pte. Ltd.', url: 'https://manus.im/' },
  },
  {
    regex: 'HubSpotContentSearchBot',
  ...
  },
  {
    ...
    producer: { name: 'ProRataAI, Inc.', url: 'https://prorata.ai/' },
  },
  {
    regex: 'blackboardally',
    name: 'Blackboard Ally',
    category: 'Crawler',
    url: 'https://ally.ac/',
    producer: { name: 'Anthology Inc.', url: 'https://www.anthology.com/' },
  },
  {
    ...
    producer: { name: 'Semantic Visions, s.r.o.', url: 'https://www.semantic-visions.com/' },
  },
  {
    ...
    producer: { name: 'Ben Kurtovic', url: 'https://github.com/earwig' },
  },
  {
    regex: 'Eyeotabot',
    name: 'Eyeotabot',
    ...
    producer: { name: 'Eyeota Pte Ltd', url: 'https://www.eyeota.com/' },
  },
  {
    regex: 'YioopBot',
    name: 'YioopBot',
    ...
    producer: { name: 'Chris Pollett', url: 'https://www.pollett.org/' },
  },
  {
    regex: 'yoozBot',
    name: 'yoozBot',
    ...
    producer: { name: 'yooz', url: 'https://www.yooz.ir/' },
  },
  {
    regex: 'ProxyChecker',
    name: 'ProxyChecker',
    ...
    producer: { name: 'IPLark', url: 'https://iplark.com/' },
  },
  {
    regex: 'StackScopeBot',
    name: 'StackScopeBot',
    category: 'Crawler',
    url: 'https://stackscope.dev/bot',
    producer: { name: 'StackScope', url: 'https://stackscope.dev/' },
  },
  {
    regex: 'AffiliateSpyBot',
    name: 'AffiliateSpyBot',
    category: 'Crawler',
    url: 'https://www.affiliatespy.io/',
    producer: { name: 'Wayfinity Ltd', url: 'https://www.wayfinity.io/' },
  },
  {
    regex: 'visionheight\\.com',
    name: 'VisionHeight',
    category: 'Security Checker',
    url: 'https://www.visionheight.com/scan',
    producer: { name: 'Vision Height Ltd', url: 'https://www.visionheight.com/' },
  },
  {
    regex: 'AccessibleWebBot',
    name: 'AccessibleWebBot',
    category: 'Crawler',
    url: 'https://accessibleweb.com/bot/',
    producer: { name: 'Accessible Web Inc.', url: 'https://accessibleweb.com/' },
  },
  {
    regex: 'MarketGoo',
    name: 'MarketGoo',
    ...
    producer: { name: 'MARKETGOO INTERNET, S.L.', url: 'https://www.marketgoo.com/' },
  },
  {
    regex: 'RootEvidence',
    name: 'RootEvidence',
    category: 'Security Checker',
    url: 'https://www.rootevidence.com/',
    producer: { name: 'Root Evidence, Inc.', url: 'https://www.rootevidence.com/' },
  },
  { regex: 'UdV-AI-Research', name: 'UdV-AI-Research', category: 'AI Data Scraper' },
  { regex: 'TrustBot', name: 'TrustBot', category: 'Crawler', url: 'https://truster.info/en/' },
  { regex: 'Centurybot', name: 'Centurybot', category: 'Search bot', url: 'https://rightdao.com/bot.html' },
  {
    regex: 'KimiBot',
    name: 'KimiBot',
    category: 'AI Data Scraper',
    url: 'https://www.kimi.com/policies/kimi-crawlers',
    producer: { name: 'Moonshot AI Pte. Ltd.', url: 'https://www.moonshot.ai/' },
  },
  {
  ...
  { regex: 'AffsignalCrawler', name: 'AffsignalCrawler', category: 'Crawler', url: 'https://affsignal.com/bot' },
  {
    regex: '(GoGuides(?:Crawler|DiscoveryBot))',
    name: '$1',
    category: 'AI Search Crawler',
    url: 'https://www.goguides.com/crawler',
    producer: { name: 'GoGuides, LLC', url: 'https://www.goguides.com/' },
  },
  {
  ...
  { regex: 'RankPulseBot', name: 'RankPulseBot', category: 'Crawler', url: 'https://rankpulse.app/' },
  { regex: 'PipericBot', name: 'PipericBot', category: 'Crawler', url: 'https://piperic.com/bot' },
  { regex: 'OrlightBot', name: 'OrlightBot', category: 'Search bot', url: 'https://orlight.net/' },
  { regex: 'urlsuma', name: 'urlsuma', category: 'Search bot', url: 'https://urlsuma.de/bot.html' },
  {
    regex: 'SocialPushBot',
    name: 'SocialPushBot',
    category: 'Crawler',
    url: 'https://socialpush.com/',
    producer: { name: 'RP NET MEDIA SRL' },
  },
  { regex: 'PriEcoBot', name: 'PriEcoBot', category: 'Search bot', url: 'https://prieco.net' },
  {
    regex: 'DnesAkceBot',
    name: 'DnesAkceBot',
    category: 'Crawler',
    url: 'https://dnesakce.cz/',
    producer: { name: 'Easy Call 09, s.r.o.' },
  },
  { regex: 'cl0q-crawler', name: 'cl0q-crawler', category: 'Search bot', url: 'https://cl0q.com/bot/' },
  {
    regex: 'InfoGuardDisclosureResearch',
    name: 'InfoGuardDisclosureResearch',
    category: 'Security Checker',
    url: 'https://www.infoguard.ch/',
    producer: { name: 'InfoGuard AG', url: 'https://www.infoguard.ch/' },
  },
  { regex: 'FindiseBot', name: 'FindiseBot', category: 'Search bot', url: 'https://findise.net/' },
  {
    regex: '(GreenWebChecker|gwf-carbon-txt-crawler)',
    name: '$1',
    category: 'Crawler',
    url: 'https://www.thegreenwebfoundation.org/green-web-checker-faq/',
    producer: { name: 'Green Web Foundation', url: 'https://www.thegreenwebfoundation.org/' },
  },
  ...
  { regex: 'vercel-screenshot', name: 'Vercel Screenshot' },
  { regex: 'PhantomJsCloud\\.com', name: 'PhantomJsCloud' },
  { regex: 'YisouSpider', name: 'YisouSpider' },
];
