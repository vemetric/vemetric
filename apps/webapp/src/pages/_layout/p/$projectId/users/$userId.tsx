                              ...
                              {user.referrer && (
                                <>
                                  ...
                                  <Flex justify="flex-end">
                                    <Tooltip
                                      content={
                                        user.referrer ? `Referred via ${user.referrerUrl}` : `Direct page visit.`
                                      }
                                    >
                            ...
                            <Alert.Root status="info" variant="surface" mt={5} p={2}>
                              <Alert.Content>
                                <Alert.Description>
                                  ...
                                  <Text mt={2}>
                                    It also allows you to attach attributes to them in order to store helpful
                                    information for each of your users.
                                  </Text>
                                </Alert.Description>
                              </Alert.Content>
                            </Alert.Root>
