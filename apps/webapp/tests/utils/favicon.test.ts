...
describe('getFaviconUrl', () => {
  it('should handle URLs with https protocol', () => {
    ...
    const expected = 'https://favicon.vemetric.com/https://example.com?size=64';
  ...
  it('should handle URLs with subdomains', () => {
    ...
    const expected = 'https://favicon.vemetric.com/https://sub.example.com?size=64';
    expect(getFaviconUrl(url)).toBe(expected);
  });

  it('should handle invalid URLs gracefully', () => {
    const url = 'not-a-url';
    const expected = 'https://favicon.vemetric.com/https://not-a-url?size=64';
    expect(getFaviconUrl(url)).toBe(expected);
  });
});
