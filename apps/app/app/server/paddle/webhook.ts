...
import { getClientIpFromRequest } from '@vemetric/common/request-ip';
...
export async function validateWebhook(request: Request): Promise<EventEntity | null> {
